...
public class CliConfig extends ApiObjectBase {
	...
	public List<String> getDefaultParent() {
		return List.of("default-global-system-config", "default-physical-router");
	}
	...
	public void setParent(final PhysicalRouter parent) {
	...
	public void setAcceptedCliConfig(final String accepted_cli_config) {
	...
	public void setCommitDiffList(final CliDiffListType commit_diff_list) {
