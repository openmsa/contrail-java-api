...
public class AccessControlList extends ApiObjectBase {
	...
	public void setParent(final SecurityGroup parent) {
		super.setParent(parent);
	}
	...
	public void setEntries(final AclEntriesType access_control_list_entries) {
	...
	public void setHash(final Long access_control_list_hash) {
