...
public class BgpRouter extends ApiObjectBase {
	...
	public void setControlNodeZone(final ControlNodeZone obj) {
		control_node_zone_refs = new ArrayList<>();
		control_node_zone_refs.add(new ObjectReference<>(obj.getQualifiedName(), null));
	}

	public void addControlNodeZone(final ControlNodeZone obj) {
	...
	public void removeControlNodeZone(final ControlNodeZone obj) {
		if (control_node_zone_refs != null) {
			control_node_zone_refs.remove(new ObjectReference<>(obj.getQualifiedName(), null));
		}
	}
