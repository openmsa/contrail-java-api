...
public class Alarm extends ApiObjectBase {
	...
	public void setUveKeys(final UveKeysType uve_keys) {
	...
	public void setSeverity(final Integer alarm_severity) {
	...
	public void setRules(final AlarmOrList alarm_rules) {
